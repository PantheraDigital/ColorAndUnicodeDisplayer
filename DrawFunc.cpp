...
void Draw::operator()(int disp, int x, int y, int color)
{
	SetConsoleTextAttribute(m_hOutput, color);//set color
	(*this)(disp, x, y);
	SetConsoleTextAttribute(m_hOutput, LIGHTGREY);//set back to default color
...
void Draw::operator()(std::string disp, int x, int y, int color)
{
	SetConsoleTextAttribute(m_hOutput, color);//set color
	(*this)(disp, x, y);
	SetConsoleTextAttribute(m_hOutput, LIGHTGREY);//set back to default color
...
void Draw::operator()(char disp, int color)
{
	SetConsoleTextAttribute(m_hOutput, color);//set color
	(*this)(disp);
	SetConsoleTextAttribute(m_hOutput, LIGHTGREY);//set back to default color
...
void Draw::operator()(int disp, int color)
{
	SetConsoleTextAttribute(m_hOutput, color);//set color
	(*this)(disp);
	SetConsoleTextAttribute(m_hOutput, LIGHTGREY);//set back to default color
...
void Draw::operator()(std::string disp, int color)
{
	SetConsoleTextAttribute(m_hOutput, color);//set color
	(*this)(disp);
	SetConsoleTextAttribute(m_hOutput, LIGHTGREY);//set back to default color
